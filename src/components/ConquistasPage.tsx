...
const ConquistasPage: React.FC = () => {
  ...
  const conquistasLinha2 = [
    { imagem: p5, ativado: true, onClick: () => { showRectangle(conquistasLinha2[0], setRectangle5Active); } },
    { imagem: p6, ativado: true, onClick: () => { showRectangle(conquistasLinha2[1], setRectangle6Active); } },
    { imagem: p7, ativado: true, onClick: () => { showRectangle(conquistasLinha2[2], setRectangle7Active); } },
    { imagem: p8, ativado: true, onClick: () => { showRectangle(conquistasLinha2[3], setRectangle8Active); } },
  ];
  const conquistasLinha3 = [
    { imagem: p9, ativado: true, onClick: () => { showRectangle(conquistasLinha3[0], setRectangle9Active); } },
    { imagem: p10, ativado: true, onClick: () => { showRectangle(conquistasLinha3[1], setRectangle10Active); } },
    { imagem: p11, ativado: true, onClick: () => { showRectangle(conquistasLinha3[2], setRectangle11Active); } },
    { imagem: p12, ativado: true, onClick: () => { showRectangle(conquistasLinha3[3], setRectangle12Active); } },
  ];
  const conquistasLinha4 = [
    { imagem: p13, ativado: true, onClick: () => { showRectangle(conquistasLinha4[0], setRectangle13Active); } },
    { imagem: p14, ativado: true, onClick: () => { showRectangle(conquistasLinha4[1], setRectangle14Active); } },
    { imagem: p15, ativado: true, onClick: () => { showRectangle(conquistasLinha4[2], setRectangle15Active); } },
    { imagem: p16, ativado: true, onClick: () => { showRectangle(conquistasLinha4[3], setRectangle16Active); } },
  ];
  const conquistasLinha5 = [
    { imagem: p17, ativado: true, onClick: () => { showRectangle(conquistasLinha5[0], setRectangle17Active); } },
    { imagem: p18, ativado: true, onClick: () => { showRectangle(conquistasLinha5[1], setRectangle18Active); } },
    { imagem: p19, ativado: true, onClick: () => { showRectangle(conquistasLinha5[2], setRectangle19Active); } },
    { imagem: p20, ativado: true, onClick: () => { showRectangle(conquistasLinha5[3], setRectangle20Active); } },
  ];
  const conquistasLinha6 = [
    { imagem: p21, ativado: true, onClick: () => { showRectangle(conquistasLinha6[0], setRectangle21Active); } },
  ];
  ...
  return (
    <div>
      ...
      <Espaco altura="50px" />
      <TextosEmLinha textoEsquerda="conquistas" textoDireita="7/21" largura="337px" />
      <Espaco altura="20px" />
      ...
      <div onClick={() => hideRectangle(setRectangle6Active)}>
        ...
        <OverlayRectangle active={isRectangleActive6}>
          ...
          <Espaco altura="10px" />
          <Porcentagem porcentagens= {[
            { imagemSrc: fichaMulticolorImage, texto: "20%", tamanhoFonte: "28px", marginRight: "0px"},
          ]}
          />
        </OverlayRectangle>
      </div>
      ...
      <div onClick={() => hideRectangle(setRectangle7Active)}>
        ...
        <OverlayRectangle active={isRectangleActive7}>
          ...
          <Espaco altura="10px" />
          <Porcentagem porcentagens= {[
            { imagemSrc: fichaRosaImage, texto: "60% -", tamanhoFonte: "28px", marginRight: "4px"},
            { imagemSrc: fichaRosaImage, texto: "80%", tamanhoFonte: "28px", marginRight: "0px"},
          ]}
          />
        </OverlayRectangle>
      </div>
      ...
      <div onClick={() => hideRectangle(setRectangle8Active)}>
        ...
        <OverlayRectangle active={isRectangleActive8}>
          ...
          <Espaco altura="10px" />
          <Porcentagem porcentagens= {[
            { imagemSrc: fichaAmarelaImage, texto: "60% -", tamanhoFonte: "28px", marginRight: "4px"},
            { imagemSrc: fichaAmarelaImage, texto: "80%", tamanhoFonte: "28px", marginRight: "0px"},
          ]}
          />
        </OverlayRectangle>
      </div>
      ...
      <div onClick={() => hideRectangle(setRectangle9Active)}>
        ...
        <OverlayRectangle active={isRectangleActive9}>
          ...
          <Espaco altura="10px" />
          <Porcentagem porcentagens= {[
            { imagemSrc: fichaVerdeImage, texto: "60% -", tamanhoFonte: "28px", marginRight: "4px"},
            { imagemSrc: fichaVerdeImage, texto: "80%", tamanhoFonte: "28px", marginRight: "0px"},
          ]}
          />
        </OverlayRectangle>
      </div>
      ...
      <div onClick={() => hideRectangle(setRectangle10Active)}>
        ...
        <OverlayRectangle active={isRectangleActive10}>
          ...
          <Espaco altura="10px" />
          <Porcentagem porcentagens= {[
            { imagemSrc: fichaLaranjaImage, texto: "60% -", tamanhoFonte: "28px", marginRight: "4px"},
            { imagemSrc: fichaLaranjaImage, texto: "80%", tamanhoFonte: "28px", marginRight: "0px"},
          ]}
          />
        </OverlayRectangle>
      </div>
      ...
      <div onClick={() => hideRectangle(setRectangle11Active)}>
        ...
        <OverlayRectangle active={isRectangleActive11}>
          ...
          <Espaco altura="10px" />
          <Porcentagem porcentagens= {[
            { imagemSrc: fichaRoxaImage, texto: "60% -", tamanhoFonte: "28px", marginRight: "4px"},
            { imagemSrc: fichaRoxaImage, texto: "80%", tamanhoFonte: "28px", marginRight: "0px"},
          ]}
          />
        </OverlayRectangle>
      </div>
      ...
      <div onClick={() => hideRectangle(setRectangle12Active)}>
        ...
        <OverlayRectangle active={isRectangleActive12}>
          ...
          <Espaco altura="10px" />
          <Porcentagem porcentagens= {[
            { imagemSrc: fichaRosaImage, texto: "40%", tamanhoFonte: "28px"},
            { imagemSrc: fichaVerdeImage, texto: "40%", tamanhoFonte: "28px", marginRight: "0px"},
          ]}
          />
          <Porcentagem porcentagens= {[
            { imagemSrc: fichaAmarelaLaranjaRoxaImage, texto: "20%", tamanhoFonte: "28px", marginRight: "0px"},
          ]}
          />
        </OverlayRectangle>
      </div>
      ...
      <div onClick={() => hideRectangle(setRectangle13Active)}>
        ...
        <OverlayRectangle active={isRectangleActive13}>
          ...
          <Espaco altura="10px" />
          <Porcentagem porcentagens= {[
            { imagemSrc: fichaAmarelaImage, texto: "40%", tamanhoFonte: "28px"},
            { imagemSrc: fichaLaranjaImage, texto: "40%", tamanhoFonte: "28px", marginRight: "0px"},
          ]}
          />
          <Porcentagem porcentagens= {[
            { imagemSrc: fichaVerdeRosaRoxaImage, texto: "20%", tamanhoFonte: "28px", marginRight: "0px"},
          ]}
          />
        </OverlayRectangle>
      </div>
      ...
      <div onClick={() => hideRectangle(setRectangle14Active)}>
        ...
        <OverlayRectangle active={isRectangleActive14}>
          ...
          <Espaco altura="10px" />
          <Porcentagem porcentagens= {[
            { imagemSrc: fichaVerdeImage, texto: "40%", tamanhoFonte: "28px"},
            { imagemSrc: fichaAmarelaImage, texto: "40%", tamanhoFonte: "28px", marginRight: "0px"},
          ]}
          />
          <Porcentagem porcentagens= {[
            { imagemSrc: fichaLaranjaRosaRoxaImage, texto: "20%", tamanhoFonte: "28px", marginRight: "0px"},
          ]}
          />
        </OverlayRectangle>
      </div>
      ...
      <div onClick={() => hideRectangle(setRectangle15Active)}>
        ...
        <OverlayRectangle active={isRectangleActive15}>
          ...
          <Espaco altura="10px" />
          <Porcentagem porcentagens= {[
            { imagemSrc: fichaLaranjaImage, texto: "40%", tamanhoFonte: "28px"},
            { imagemSrc: fichaRoxaImage, texto: "40%", tamanhoFonte: "28px", marginRight: "0px"},
          ]}
          />
          <Porcentagem porcentagens= {[
            { imagemSrc: fichaVerdeAmarelaRosaImage, texto: "20%", tamanhoFonte: "28px", marginRight: "0px"},
          ]}
          />
        </OverlayRectangle>
      </div>
      ...
      <div onClick={() => hideRectangle(setRectangle16Active)}>
        ...
        <OverlayRectangle active={isRectangleActive16}>
          ...
          <Espaco altura="10px" />
          <Porcentagem porcentagens= {[
            { imagemSrc: fichaRoxaImage, texto: "40%", tamanhoFonte: "28px"},
            { imagemSrc: fichaRosaImage, texto: "40%", tamanhoFonte: "28px", marginRight: "0px"},
          ]}
          />
          <Porcentagem porcentagens= {[
            { imagemSrc: fichaLaranjaAmarelaVerdeImage, texto: "20%", tamanhoFonte: "28px", marginRight: "0px"},
          ]}
          />
        </OverlayRectangle>
      </div>
      ...
      <div onClick={() => hideRectangle(setRectangle17Active)}>
        ...
        <OverlayRectangle active={isRectangleActive17}>
          ...
          />
          <Porcentagem porcentagens= {[
            { imagemSrc: fichaVerdeLaranjaRoxaImage, texto: "20%", tamanhoFonte: "28px", marginRight: "0px"},
          ]}
          />
        </OverlayRectangle>
      </div>
      ...
      <div onClick={() => hideRectangle(setRectangle18Active)}>
        ...
        <OverlayRectangle active={isRectangleActive18}>
          ...
          />
          <Porcentagem porcentagens= {[
            { imagemSrc: fichaVerdeRosaLaranjaImage, texto: "20%", tamanhoFonte: "28px", marginRight: "0px"},
          ]}
          />
        </OverlayRectangle>
      </div>
      ...
      <div onClick={() => hideRectangle(setRectangle19Active)}>
        ...
        <OverlayRectangle active={isRectangleActive19}>
          ...
          />
          <Porcentagem porcentagens= {[
            { imagemSrc: fichaAmarelaLaranjaRosaImage, texto: "20%", tamanhoFonte: "28px", marginRight: "0px"},
          ]}
          />
        </OverlayRectangle>
      </div>
      ...
      <div onClick={() => hideRectangle(setRectangle20Active)}>
        ...
        <OverlayRectangle active={isRectangleActive20}>
          ...
          />
          <Porcentagem porcentagens= {[
            { imagemSrc: fichaAmarelaRosaRoxaImage, texto: "20%", tamanhoFonte: "28px", marginRight: "0px"},
          ]}
          />
        </OverlayRectangle>
      </div>
      ...
      <div onClick={() => hideRectangle(setRectangle21Active)}>
        ...
        <OverlayRectangle active={isRectangleActive21}>
          ...
          />
          <Porcentagem porcentagens= {[
            { imagemSrc: fichaVerdeAmarelaRoxaImage, texto: "20%", tamanhoFonte: "28px", marginRight: "0px"},
          ]}
          />
        </OverlayRectangle>
      </div>
