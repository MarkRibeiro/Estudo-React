...
const cenario = [
  {//cenário 01
    ...
    textoCaixaGrande: "Uma pessoa está andando muito lentamente na sua frente. Infelizmente, não tem espaço o suficiente para ultrapassar a pessoa na calçada e vocês parecem estar indo para o mesmo lugar.",
    ...
    cartaRoxa: "Toca um som de sino de bicicleta para ver se a pessoa sai da frente."
  },
  
  {//cenário 02
    fundo: fundo02,
    textoCaixaPequena: "Cenário 02",
    textoCaixaGrande: "Sua aula é no prédio mais alto da faculdade em um dos últimos andares. Você foi o primeiro a chegar e a aula só começa em 30 min.",
  ...
  {//cenário 03
    ...
    textoCaixaGrande: "Você está esperando o metrô há muito tempo e a estação está ficando cada vez mais cheia.",
  ...
  {//cenário 04
    ...
    textoCaixaGrande: "Você está tentando dormir faz 1 hora, mas a criança que mora no andar de cima não para de derrubar seus brinquedos no chão fazendo um barulho bem alto.",
    cartaVerde: "Fica com insônia de tanto pensar se vai conseguir dormir novamente.",
  ...
  {//cenário 05
    ...
    textoCaixaGrande: "Você está esperando para ser atendido no dentista há muito tempo e ele está extremamente atrasado. Na sala só estão você e a secretária. Ao seu lado tem uma mesa cheia de revistas.",
    cartaVerde: "Leva o atraso como um sinal de que você nunca mais deve voltar ao dentista.",
  ...
  {//cenário 06
    ...
    textoCaixaGrande: "Você está descendo as escadas da faculdade e no meio do caminho encontra duas pessoas sentadas nos degraus. Não há espaço para continuar sem esbarrar em pelo menos uma delas.",
    cartaVerde: "Automaticamente fica paralisado com receio de nunca conseguir descer.",
  ...
  {//cenário 07
    ...
    textoCaixaGrande: "Você vai para o banheiro e ao entrar na cabine, percebe que a pessoa anterior esqueceu de dar descarga.",
    ...
    cartaRosa: "Acha quem não deu a descarga e enfia a cabeça dessa pessoa na privada.",
  ...
  {//cenário 08
    ...
    textoCaixaGrande: "Você está na sua prova da autoescola e acabou de sair da baliza. O 2º instrutor está quase entrando no carro.",
  ...
  { //cenário 09
    ...
    textoCaixaGrande: "Você está viajando com os seus amigos de carro e está sentado no banco do carona.",
    cartaVerde: "Passa a viagem toda segurando na alça do teto a espera de possíveis acidentes.",
    cartaAmarela: "Bota a cabeça e a língua para fora do carro que nem um cachorro.",
  ...
  { //cenário 10
    ...
    textoCaixaGrande: "Você estava no hospital fazendo um check up e foi liberado para ir para casa. Ao tentar achar a saída, você se perdeu pelos corredores.",
    cartaVerde: "Começa a passar mal achando que nunca mais vai conseguir voltar para casa.",
    ...
    cartaRoxa: "Se sente como um estudante de medicina e invade o centro cirúrgico."
  },
  
  { //cenário 11
    fundo: fundo11,
    textoCaixaPequena: "Cenário 11",
    textoCaixaGrande: "Você foi com a sua família na missa de domingo. A igreja está insuportavelmente lotada e quente.",
  ...
  { //cenário 12
    ...
    textoCaixaGrande: "Você está viajando sozinho de avião. No momento está escuro e todos estão dormindo.",
    cartaVerde: "Dorme com um paraquedas para se preparar para quaisquer problemas de voo.",
    cartaAmarela: "Abre a porta do avião.",
    cartaLaranja: "Fecha todas as janelas do avião.",
    cartaRosa: "Grita e acorde todos no avião.",
    cartaRoxa: "Liga a internet do seu celular para testar se realmente dá interferência."
  },
  
  { //cenário 13
    fundo: fundo13,
    textoCaixaPequena: "Cenário 13",
    textoCaixaGrande: "Você mora em um condomínio de casas. Ao sair de casa, você percebe que o seu vizinho pintou a fachada de uma cor horrocartaRosa e você não gostou nem um pouco.",
    cartaVerde: "Considere falar com o síndico em busca de uma lei para que os moradores não pintem suas casas com cores horrendas.",
    cartaAmarela: "Paga na mesma moeda, pinta a sua casa da cor que o seu vizinho menos gosta.",
    cartaLaranja: "Tira uma foto e compartilha em busca do culpado.",
    cartaRosa: "Repinta você mesmo durante a madrugada.",
    cartaRoxa: "Estraga a pintura do vizinho jogando algo molhado ou nojento na fachada."
  },
  
  { //cenário 14
    fundo: fundo14,
    textoCaixaPequena: "Cenário 14",
    textoCaixaGrande: "Você está cuidando de um bebê e ele não para de chorar. Enquanto tentava acalma-lo, seu vizinho começou a reclamar do barulho.",
    cartaVerde: "Começa a chorar também com receio de nunca mais conseguir fazer o bebê se acalmar.",
  ...
  { //cenário 15
    ...
    textoCaixaGrande: "Você está no trânsito e acabou de acontecer um acidente na sua frente.",
