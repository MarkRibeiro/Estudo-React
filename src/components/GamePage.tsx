...
const GamePage: React.FC = () => {
  ...
  return (
    <div>
      ...
      >
        <BotaoGrandeImagem texto="criar cenário" imagemSrc={imagensImage} />
      </Link>
      <Linha
        comprimento="90%"
        cor="black"
      ...
      {isRectangleActive1 && (
        <div onClick={handleHideRectangle1Click}>
          ...
          <OverlayRectangle active={isRectangleActive1}>
            ...
            <Espaco altura="20px" />
            <Texto
              texto="Caso caia em uma casa **sem** um **QR code**, clique no botão:"
              fonte="20px"
              largura="249px"
              alinhamento="center"
            />
      ...
      {isRectangleActive2 && (
        <div onClick={handleHideRectangle2Click}>
          ...
          <OverlayRectangle active={isRectangleActive2}>
            ...
            <Espaco altura="20px" />
            <Texto
              texto="Não esqueça de adicionar todas as suas fichas **antes do final do jogo**"
              fonte="20px"
              largura="249px"
              alinhamento="center"
            />
